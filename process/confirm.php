...
<form id="frmcart" name="frmcart" method="post" action="saveorder.php">
  <table width="600" border="0" align="center" class="square">
    ...
    <tr>
      ...
      <td align="center" bgcolor="#F9D5E3">กิโลละ</td>
      <td align="center" bgcolor="#F9D5E3">กิโลกรัม</td>
      <td align="center" bgcolor="#F9D5E3">รวมทั้งสิ้น</td>
    </tr>
<?php
	$total=0;
...
<tr>
    <td width="22%" bgcolor="#EEEEEE">รหัสนักศึกษา</td>
    <td width="78%"><input name="numstudent" type="text" id="numstudent" required></td>
</tr>
<tr>
